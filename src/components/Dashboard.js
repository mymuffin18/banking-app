...
function Dashboard() {
  ...
  return (
    <div className="h-screen">
      <div className="bg-gradient-to-r from-blue-300 to-indigo-700 h-auto p-1 flex justify-center items-center mb-6 mt-6">
      ...
      <div className="grid lg:grid-cols-5 gap-4">
        ...
        {openDepositModal && (
          <DepositModal closeDepositModal={setOpenDepositModal} id={id} />
        )}
        ...
        {openTransferModal && (
          <TransferModal closeTransferModal={setOpenTransferModal} id={id} />
        )}
