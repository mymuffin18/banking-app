...
function DateExpensesList() {
  ...
  return (
    <div className="flex justify-center">
      <div className="w-5/6 mt-5 md:mt-10 lg:mt-20 xl:mt-20 2xl:mt-20 lg:mb-20 max-h-48 md:max-h-96 lg:max-h-96 card glass overflow-scroll overflow-x-hidden">
        ...
        <div className="flex flex-row justify-center">
          ...
          <div className="border border-solid border-indigo-700 w-1/3">
            <p className="font-semibold text-center">Expenses</p>
          </div>
          <div className="border border-solid border-indigo-700 w-1/6">
              ...
              >
                <div className="w-5/6">
                  <div className="flex justify-center items-center">
                    <div className="w-1/6">
                      <p className="text-center">{userExpense.date}</p>
                    </div>{" "}
                    <div className="w-5/12">
                      <p className="text-center">{userExpense.text}</p>
                    </div>{" "}
                    <div className="w-1/6">
                      <p className="text-center">{userExpense.amount}</p>
                    </div>
